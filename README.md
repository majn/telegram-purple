...
1. Download and execute the [Telegram-Adium bundle] (https://github.com/majn/telegram-purple/releases/download/v1.4.2/telegram-adium-1.4.2.AdiumLibpurplePlugin.zip)
2. Restart Adium
